...
## Extra stuff I had to do:

- Install `@bufbuild/protobuf`
- Install `@livekit/rtc-node`
- Install `@livekit/agents`
- Install `@livekit/agents-plugin-openai`
- Install `@livekit/agents-plugin-elevenlabs`
- Install `@livekit/agents-plugin-deepgram`
- Install `@livekit/agents-plugin-elevenlabs`
- Install `@livekit/agents-plugin-openai`
- Install `@livekit/rtc-node`

Add environment variables to `.env.local`
load the env in agent.ts
